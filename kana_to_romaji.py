...
def change_character():
    ...
    if st.session_state.mode in SELECT_KANA_DICT:
        st.session_state.character = random.choice(SELECT_KANA_DICT[st.session_state.mode])
    else:
...
if st.session_state.mode is not None:
    ...
    if st.session_state.character is None:
        # Initialize the character if not already set
        st.session_state.character = random.choice(SELECT_KANA_DICT[st.session_state.mode])
